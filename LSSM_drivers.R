...
# 2026/01/11: Data loading now focused on 2025 data. See GIT for earlier BATI work. 
#################################################################################
...
# Minidot data: Temp, DO, DO_sat, Q
#   mdot_focal, mdot_ref

# Light includes both hourly PAR and Daily light interval
#   DLI_df, par_df
