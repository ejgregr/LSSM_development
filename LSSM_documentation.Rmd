...
This leads to and estimate of kgWW / yr / plant of 9.23 kg (0.30 / 0.25 / 0.13). Not unreasonable. This can  be scaled to daily or monthly growth, by disaggregating total annual daylight hours (Weigel and Pfister 2021). From this we could also back calculate: 
...
*Alkalinity*
Alkalinity has a strong relationship with salinity. BATI moorings have salinity, so can get TA from the following equation (Evans et al. 2015):
